...
privileged aspect NetSwitchController_Roo_Controller {
    ...
    public String NetSwitchController.create(@Valid Switches switches, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        switches.persist();
        return "redirect:/netswitches/" + encodeUrlPathSegment(switches.getId().toString(), httpServletRequest);
    }
    ...
    public String NetSwitchController.update(@Valid Switches switches, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, switches);
    ...
    void NetSwitchController.populateEditForm(Model uiModel, Switches switches) {
