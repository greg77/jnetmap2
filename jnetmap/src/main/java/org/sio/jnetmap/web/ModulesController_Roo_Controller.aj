...
import org.sio.jnetmap.web.ModulesController;
...
privileged aspect ModulesController_Roo_Controller {
    ...
    public String ModulesController.create(@Valid Modules modules, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        modules.persist();
        return "redirect:/moduleses/" + encodeUrlPathSegment(modules.getId().toString(), httpServletRequest);
    }
    ...
    public String ModulesController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String ModulesController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, Modules.findModules(id));
        return "moduleses/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ModulesController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
